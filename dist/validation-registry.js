 ...
 */
export const TYPE_CHECKS = new Set([
    {
        name: "isString",
        typeTag: "string",
 ...
 */
export const STRING_CHECKS = new Set([
    {
        name: "notEmpty",
        typeTag: "string",
    ...
    },
    {
        ...
        check: (value, prefix) => typeof value === "string" && value.startsWith(prefix),
    ...
    },
    {
        ...
        check: (value, suffix) => typeof value === "string" && value.endsWith(suffix),
 ...
 */
export const NUMBER_CHECKS = new Set([
    {
        name: "greaterThan",
        typeTag: "number",
    ...
    },
    {
        ...
        check: (value, min, max) => typeof value === "number" && value >= min && value <= max,
 ...
 */
export const ARRAY_CHECKS = new Set([
    {
        name: "notEmpty",
        typeTag: "array",
    ...
    },
    {
        ...
        check: (value) => Array.isArray(value) && value.every((item) => typeof item === "number"),
        examples: [
            [1, 2, 3],
            [1.5, 2.5],
        ],
 ...
 */
export const OBJECT_CHECKS = new Set([
    {
        name: "hasKey",
        typeTag: "object",
        description: "Object has specific key",
        check: (value, key) => typeof value === "object" && value !== null && key in value,
 ...
 */
export const ADVANCED_CHECKS = new Set([
    {
        name: "isFunction",
        typeTag: "function",
    ...
    },
    {
        ...
        check: (value) => value != null && typeof value.then === "function",
 ...
 */
export function getApplicableChecks(value) {
    const checks = [];
 ...
 */
export function getChecksByType(typeTag) {
