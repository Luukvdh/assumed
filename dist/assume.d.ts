...
type BaseChain<T> = {
    that(predicate: (v: T) => boolean, msg?: string): AssumptionFn<T> & BaseChain<T>;
...
type NumberChain = BaseChain<number> & {
    ...
    between(min: number, max: number, msg?: string): AssumptionFn<number> & NumberChain;
};
type ElementChain = BaseChain<any> & {
    ...
    hasChildMatching(selector: string, msg?: string): AssumptionFn<any> & ElementChain;
    hasDescendant(selector: string, msg?: string): AssumptionFn<any> & ElementChain;
    hasAttribute(name: string, msg?: string): AssumptionFn<any> & ElementChain;
    attributeEquals(name: string, expected: string, msg?: string): AssumptionFn<any> & ElementChain;
};
type ObjectChain = BaseChain<Record<string, unknown>> & {
    hasKey<K extends string>(key: K, msg?: string): AssumptionFn<Record<string, unknown>> & ObjectChain;
    hasKeys<K extends string>(...keys: K[]): AssumptionFn<Record<string, unknown>> & ObjectChain;
    keyEquals<K extends string>(key: K, expected: unknown, msg?: string): AssumptionFn<Record<string, unknown>> & ObjectChain;
};
type ArrayChain = BaseChain<unknown[]> & {
    ...
    itemIsBoolean(index: number, msg?: string): AssumptionFn<unknown[]> & ArrayChain;
    itemIsString(index: number, msg?: string): AssumptionFn<unknown[]> & ArrayChain;
    itemIsNumber(index: number, msg?: string): AssumptionFn<unknown[]> & ArrayChain;
    itemIsObject(index: number, msg?: string): AssumptionFn<unknown[]> & ArrayChain;
};
type StringChain = BaseChain<string> & {
    ...
    lengthBetween(min: number, max: number, msg?: string): AssumptionFn<string> & StringChain;
    contains(needle: string | RegExp, msg?: string): AssumptionFn<string> & StringChain;
    ...
    equalsIgnoreCase(expected: string, msg?: string): AssumptionFn<string> & StringChain;
    includesAny(...needles: string[]): AssumptionFn<string> & StringChain;
    includesAll(...needles: string[]): AssumptionFn<string> & StringChain;
    isJSON(msg?: string): AssumptionFn<string> & StringChain;
};
type AssumptionFn<T> = (() => boolean | void) & BaseChain<T> & {
...
export declare function assume<T>(value: T): AssumptionFn<T>;
export declare function that<T>(value: T): AssumptionFn<T>;
